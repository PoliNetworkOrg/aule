...
function openBuilding(
  ...
  if (notify)
    document.dispatchEvent(new CustomEvent("buildingchange", { detail: { campusId, buildingId } }));
...
function goToCampusPage({ animate, notify = true }: { animate: boolean; notify?: boolean }) {
  ...
  if (notify)
    document.dispatchEvent(
      new CustomEvent("buildingchange", { detail: { campusId, buildingId: null } }),
    );
}
